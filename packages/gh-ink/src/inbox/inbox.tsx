...
// The workflow half of this file now lives in @kud/gh-workflow so a browser can
// reach it. Imported back and re-exported by name: gh-ink's public surface is
// unchanged, and a star re-export of an external package is the exact shape that
// shipped 17 undefined exports once already.
import {
  depthOf,
  relativeTime,
  repoPriority,
