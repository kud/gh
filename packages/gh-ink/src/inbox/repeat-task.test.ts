...
describe("repeatedTaskRows", () => {
  ...
  it("leaves a genuinely different ticket alone", () => {
    const rows: AnyItem[] = [
      task("SHOP-1", "Provision", JIRA),
      task("SHOP-2", "Stand up", "https://jira/SHOP-2"),
    ]
